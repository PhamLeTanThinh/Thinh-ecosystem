...
export function BottomSheet({ open, onClose, children }: BottomSheetProps) {
  ...
  return (
    ...
    >
      <button type="button" aria-label="Đóng" onClick={onClose} className="absolute inset-0 bg-black/60 backdrop-blur-sm" />
      <div
        className={`relative z-10 max-h-[92vh] w-full max-w-[480px] overflow-y-auto rounded-t-[28px] bg-card pb-[env(safe-area-inset-bottom)] shadow-2xl transition-transform duration-300 ease-out ${
